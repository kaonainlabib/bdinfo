        ...
        <div className="flex-none">
          <ul className="flex menu menu-horizontal gap-5">
            ...
            <button className="btn-success btn">
              <NavLink to="/corona">Corona Updates</NavLink>
            </button>
            <button className="btn-primary btn btn-warning">
              <NavLink to="/population">Population</NavLink>
            </button>
          </ul>
          <label class="swap swap-rotate px-5">
  
  <input type="checkbox" onClick={first === "light" ? setfirst("dark") : setfirst("light")} />
